...
console.log('📄 Učitavam https://radio.hrt.hr/slusaonica/dnevni-ritam');
await page.goto('https://radio.hrt.hr/slusaonica/dnevni-ritam', {
...
${result.mp3}`;
  ...
  fs.writeFileSync('Dnevni_ritam.m3u', m3uContent);
